...
<div id="header"></div>
         ...
         <!-- Begin Left Column -->
		 <div id="leftcolumn"><center><strong><p>Ups !</p><br /><p> Parece que não tem permissões para ver esta página !</p>
		 <p>Verifique se tem o login efectuado ou <a href="./register.php">registe-se</a> !</p> </strong><br />
		 <img src="./images/denied.png" width="220" height="220"></center>
		 </div>
