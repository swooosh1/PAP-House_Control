		 ...
		 <div id="leftcolumn">
		 	<?php			$user=$_POST['user'];
							...
							{ 	
								...
								$query1="SELECT * FROM users WHERE username='".$user."' AND password=PASSWORD('".$pwd."')";
								$faz_query1=mysqli_query($ligaBD,$query1);
								
								if(!$faz_query1)
									echo "Erro SQL1";
				
								$num=mysqli_num_rows($faz_query1);
								if($num==1)
								{
								...
								{
									echo '<center><img width="220" height="220" src="./images/sadsmile.jpg">';
									echo '<strong><p>Erro no processo de login, tente novamente.</p>';
									echo '<p>Está registado ? <a href="registo.php">Registe-se</a> ! </p></strong></center>';
							...
							if(isset($_SESSION["userlog"]))
							{
								echo '<center><img width="220" height="220" src="./images/smile.jpg">';
								echo '<strong><p>Login efectuado com sucesso, pode navegar livremente pelo site!</p></strong></center>';
