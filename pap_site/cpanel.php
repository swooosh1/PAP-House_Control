...
<div id="header"></div>
       ...
       <div id="menu"<center>
		 ...
		 <div id="leftcolumn">			
								...
								<center><strong><p>Ligue ou Desligue o seu dispositivo:</p></strong><br />
								
								<FORM ACTION="/cgi-bin/set" METHOD="POST">
									<SELECT NAME="state" >
										<OPTION VALUE="2">--
										<OPTION VALUE="1">On
										<OPTION VALUE="0">Off
					...
					<INPUT TYPE="Submit" NAME="Submit" VALUE="Enviar"> <INPUT TYPE="RESET" VALUE="Reset">
					</FORM><br />
					
					<strong><p>Verifique se o dispositvo está ligado ou desligado:</p></strong><br />
					<FORM ACTION="/cgi-bin/get" METHOD="POST">
